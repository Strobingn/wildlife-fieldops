...
export const SPECIES = [
  "Raccoon", "Grey Squirrel", "Red Squirrel", "Flying Squirrel",
  "Bat", "Skunk", "Groundhog", "Bird", "Snake", "Opossum",
  "Rodent", "Mouse", "Rat", "Carpenter Bee", "Other"
];
...
export const STATUSES = [
  "Active", "Scheduled", "Waiting On Customer", "Trapping",
...
export const VISIT_TYPES = [
  "Inspection", "Trap Set", "Trap check", "Exclusion",
  "Repair", "Warranty Follow-Up", "Other"
];
...
export const PHOTO_TAGS = [
  "Before", "Entry Point", "Damage", "Trap Placement",
  "Droppings / Evidence", "Repair During", "After", "Warranty",
  "Customer signature"
];
...
export const ESTIMATE_TEMPLATES = {
  raccoon_attic: {
    label: "Raccoon Attic",
    species: "Raccoon",
    issue: "Raccoon activity in attic. Entry point suspected near roofline/soffit. Need inspection, exclusion, and one-way door.",
